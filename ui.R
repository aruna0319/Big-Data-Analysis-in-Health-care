...
shinyUI(fluidPage(
  ...
  # Application title
  titlePanel(title=h1("BIG DATA ANALYSIS IN HEALTH CARE ",align="center",style="margin-top: 0;
  margin-bottom: 0;
  font-size: 40px;
  font-family: Times New Roman;
  color:white;border-style: solid;
    border-width: 4px;background-color:#99CC33;border-color: white;")
  ),
  br(),
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      br(),
      actionButton("act","Update",style="float: none;
  display: table-cell; background-color:#CCFF99;font-weight: bold;
  width: 50%;"),
      br(),br(),
#       h1("HIT COUNTER"), br(),
#       h5(textOutput("count")),
...
cursor: default;"
    ...
    mainPanel(
      ...
      tags$style("body{background-color:#FFFF99;color:orange}")
